...
<div class="container mt-20">
    ...
    <div class="flex border-b border-gray-300 ">
      ...
      <a href="{{route('withdraw.create')}}"  class="mt-2 -mr-64 sm:mt-1  mb-2 block px-3 py-2 rounded-md text-base font-medium text-gray-300 bg-red-400  hover:text-white  hover:bg-red-700 focus:outline-none focus:text-white focus:bg-red-500 transition duration-150 ease-in-out">
