...
class ConfirmedPayment implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        dd($this->payment->sponsor->profile->firstname.' '.$this->payment->sponsor->profile->middlename.' '.$this->payment->sponsor->profile->lastname.' '.$this->payment->student->profile->firstname.' '.$this->payment->student->profile->middlename.' '.$this->payment->student->profile->lastname);
        $client = new Party([
        ...
        // Then send email to party with link
          $receipt = $this->payment->receipt()->update([
              'url'=> $link, 
          ]);
